        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center max-w-6xl mx-auto">
          ...
          >
            <div className="relative">
              <motion.div
                className="absolute inset-0 bg-gradient-to-br from-blue-500 to-purple-600 rounded-full blur-xl opacity-30"
                animate={{
                  scale: [1, 1.1, 1],
                  rotate: [0, 180, 360],
                }}
              ...
              >
                <img
                  src="/src/components/ui/photo.png"
                  alt="EGATA KEBEDE - Professional Photo"
          ...
          <div className="text-center lg:text-left order-1 lg:order-2">
            ...
            <motion.p
              ...
              className="text-slate-300 max-w-2xl mx-auto lg:mx-0 mb-8"
            >
            ...
            >
              {[
                ...
                { icon: Mail, href: 'mailto:egatakebede7@gmail.com' }
              ].map((social, index) => (
                <motion.a
                  key={index}
                  href={social.href}
